                    ...
                    <div class="row no-gutters h-100">
                        ...
                        <div class="col-md-4 bg-gradient-primary text-white">
                            <div class="d-flex flex-column h-100">
                                <div class="text-center p-4">
                                    <div class="profile-image-container mb-3">
                                        @if($user->foto)
                                            <img class="profile-user-img img-fluid img-circle shadow"
                                                ...
                                                style="width: 120px; height: 120px; object-fit: cover; border: 3px solid rgba(255,255,255,0.7);">
                                        @else
                                            <img class="profile-user-img img-fluid img-circle shadow"
                                    ...
                                    <p class="mb-0"><span
                                            class="badge badge-light text-primary px-3 py-1">{{ $user->getRoleName() }}</span>
                                    </p>
                                </div>
                        ...
                        <div class="col-md-8">
                            <div class="p-4 h-100 d-flex flex-column">
                                ...
                                <!-- Notifikasi Alert di Posisi Paling Atas -->
                                @if (session('success'))
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="input-group input-group-sm">
                                                    <div class="custom-file custom-file-sm">
                                                        <input type="file" name="foto"
                                                            ...
                                                            id="foto">
                                                        <label class="custom-file-label text-truncate" for="foto">Pilih file
                                                            foto</label>
                                                    </div>
                                        ...
                                        <div class="col-xl-4">
                                            <form action="{{ url('/profile/remove_foto') }}" method="POST" class="mb-0">
                                                ...
                                                @method('DELETE')
                                                <button type="submit"
                                                    class="btn btn-danger btn-sm btn-block {{ $user->foto ? '' : 'disabled' }}">
